...
export default function RegisterStepsWrapper() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-8 sm:px-6 lg:px-8  text-black dark:text-white transition-colors">
      ...
      <div className="w-full max-w-md sm:max-w-lg md:max-w-xl bg-white dark:bg-zinc-900 p-5 sm:p-8 rounded-2xl shadow-md">
