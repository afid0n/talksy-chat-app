  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white dark:bg-zinc-800 p-8 rounded-xl shadow-xl text-center">
        ...
        <p className="text-lg font-medium text-gray-600 dark:text-gray-200 mb-6">{t("check_email_heading")}</p>
        ...
        <div className="flex flex-col items-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-1">{t("check_email_heading")}</h2>
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">
            {t("check_email_subheading")}
